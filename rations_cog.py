...
✦ Elite Void (Ranged Minimum)
✦ Any: Torso / Blood Moon / Bandos / Torva / Oathplate
✦ Piety, Thralls
...
async def help(interaction: discord.Interaction):
    ...
    embed.add_field(
        name="Rations",
        value="""
        `/rations` - Shows the rations list, labor camp, and Steal/Give buttons.
        `/supremeleaderboard` - Shows all-time rations gained, longest time alive, most generous, and most dishonorable.
        """,
        inline=False
    )
